<?php  $this->Html->addCrumb('Мототехника', '');
			 if (isset($thiscrumb)) $link = '/mototechnics/motorollers/'; else $link='';
			 $this->Html->addCrumb('Мотороллеры', $link); ?>
<h1>Мотороллеры</h1>
<div class="ca-text">
<div class="companies-menu">
	...
	<?php 
		foreach ($companies as $comp) {
			echo "<a href='/mototechnics/motorollers/".$comp['mototechnics']['company']."' class='company ".$comp['mototechnics']['company']."'></a>";
	} ?>
</div>
<div class="strip"></div>
	<?php 
